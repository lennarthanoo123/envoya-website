...
(function () {
  ...
  function buildLeadWidget(container) {
    ...
    var _mob = window.innerWidth <= 900; container.style.cssText = 'width:100%;' + (_mob ? 'height:auto;' : 'height:100%;') + 'padding:20px;display:flex;align-items:stretch;box-sizing:border-box;';
